...
#    pickle.dump(y4_train, pickle_file, protocol=4)
x4_eval = pd.read_csv(tf.gfile.Open('X_test_sat4.csv'),header=None)
...
y4_eval = y4_eval.values.astype(np.float32) 
with open('x4_eval.pickle', 'wb') as pickle_file:
